...
const emit = defineEmits<{ choose: [id: string]; table: [connection: Connection, database: string, table: string]; database: [connection: Connection, database: string]; connectionHome: [connection: Connection]; newQuery: [connection: Connection]; add: []; home: []; saved: []; smart: []; history: []; settings: [] }>()
const api = useApi()
