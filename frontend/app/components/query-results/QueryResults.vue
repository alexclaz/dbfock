...
const emit = defineEmits<{ selectTab: [id: string]; closeTab: [id: string]; createTab: []; copy: [id: string]; save: [id: string, result: QueryResult]; loadMore: []; sort: [id: string, column: string, direction: 'asc' | 'desc']; refresh: [id: string] }>()
const { t } = useI18n()
